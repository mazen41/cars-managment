...
class ProductMiniCollection extends ResourceCollection
{
        ...
        return [
            'data' => $this->collection->map(function ($data) {
                ...
                return [
                    ...
                    'photos' => $this->getPhotosPaths($data->photos, $data->stocks),
    ...
    protected function getPhotosPaths($photos, $stocks){
        $photo_paths = get_images_path($photos);
        foreach ($stocks as $stockItem) {
            if ($stockItem->image != null && $stockItem->image != "") {
                $photo_paths[] =  uploaded_asset($stockItem->image);
            }
        }
        return $photo_paths;
    }
