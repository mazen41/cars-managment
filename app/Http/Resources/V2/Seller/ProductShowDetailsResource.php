...
class ProductShowDetailsResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            "id" => $this->id,
            'product_name'  => $this->getTranslation('name'),
            'product_unit'  => $this->getTranslation('unit'),
            'description'   => $this->getTranslation('description'),
            'specifications' => $this->specifications ?? [],
            "category" => $this->main_category ? $this->main_category->getTranslation('name') : null,
            "subcategory" => $this->subcategory_id ? $this->categories()->where('id', $this->subcategory_id)->first()->getTranslation('name') : null,
            "brand" => $this->brand ? $this->brand->getTranslation('name') : null,
            ...
            "tags" => $this->tags,
            "unit_price" => single_price($this->unit_price),
            ...
            "discount_type" => translate($this->discount_type),
