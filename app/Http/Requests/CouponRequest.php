...
class CouponRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $providerRule       = $this->type == 'external_order' ? 'required' : 'sometimes';
        return [
            'type'            => 'required',
            ...
            'details'         => 'required',
            'is_welcome_coupon' => 'sometimes|required'
        ];
    }
    ...
    protected function prepareForValidation()
    {
        ...
        elseif ($this->type == "external_order") {
            $data                     = array();
            $data['min_buy']          = $this->min_buy;
            $data['max_discount']     = $this->max_discount;
            $data['provider']         = $this->provider;
            $data['base_discount']    = $this->base_discount ?? 'all';
            $coupon_details           = json_encode($data);
        }
        ...
        $this->merge([
            ...
            'is_welcome_coupon' => $this->is_welcome_coupon == "on"? 1: 0
        ]);
    }
