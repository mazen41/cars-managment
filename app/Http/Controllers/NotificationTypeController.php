...
class NotificationTypeController extends Controller
{
    ...
    public function store(NotificationTypeRequest $request)
    {
        ...
        $notificationType->type = $request->type ?? 'custom';
        $notificationType->user_type = $request->user_type ?? 'customer';
        ...
        if($notificationType->save()){
            ...
            $notificationTypeTranslation = NotificationTypeTranslation::firstOrNew(['lang' => config('app.locale'), 'notification_type_id' => $notificationType->id]);
