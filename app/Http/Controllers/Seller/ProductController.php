...
class ProductController extends Controller
{
    ...
    {
        if(!auth()->user()->shop->hasCompletedPaymentInfo() || !auth()->user()->shop->hasCompletedDeliveryInfo()){
            flash(translate('You need to set up Payment and Delivery settings'))->error();
            return back();
        }
