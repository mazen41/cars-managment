...
class SupportTicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $users = User::where('user_type', 'admin')->orWhereHas('roles.permissions', function ($query){
            $query->where('name', 'view_all_support_tickets');
        })->get();
        ...
        if ($ticket->save()) {
            ...
            $data['ticket_code'] = $ticket->code;
            $data['notification_type_id'] = get_notification_type('support_ticket_new', 'type')->id;
            Notification::send($users, new SupportTicketNotification($data));
