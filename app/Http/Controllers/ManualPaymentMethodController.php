...
class ManualPaymentMethodController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $manual_payment_method->name = $request->name;
        $manual_payment_method->details = $request->details;
    ...
    public function submit_offline_payment(Request $request)
    {
        ...
        if(isset($manual_payment_method)){
            $data['method_name'] = $manual_payment_method->name;
        }else{
            $data['method_name'] ='';
        }
        ...
        $order->manual_payment_data = $data;
    ...
    public function offline_order_re_payment_modal(Request $request)
    {
        ...
        return view('manual_payment_methods.frontend.offline_order_repayment_modal', compact('order_id'));
    }
