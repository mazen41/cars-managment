...
use App\Exports\DeliveryBoysExport;
use App\Exports\DeliveryBoyPaymentHistoriesExport;
use App\Exports\DeliveryBoyCollectionHistoriesExport;
...
class DeliveryBoyController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(['permission:export_delivery_boys'])->only(['bulkExport', 'bulkExportPaymentHistries', 'bulkExportCollectionHistories']);
    }
    ...
    public function index(Request $request)
    {
        ...
        $delivery_boys = $delivery_boys->paginate($paginate);
        return view('backend.delivery_boys.index', compact('delivery_boys', 'sort_search', 'paginate'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $user->phone                = '+'.$request->country_code . str_replace(' ', '', $request->phone);
    ...
    public function update(Request $request, $id)
    {
        ...
        $delivery_boy->phone            = '+'.$request->country_code . str_replace(' ', '', $request->phone);
    ...
    public function delivery_boys_payment_histories(Request $request)
    {
        ...
        $delivery_boy_payment_query = $delivery_boy_payment_query->paginate($paginate);

        $delivery_boy_payments = $delivery_boy_payment_query;
        return view('backend.delivery_boys.delivery_boys_payment_list', compact('delivery_boy_payments', 'paginate'));
    }
    ...
    public function delivery_boys_collection_histories(Request $request)
    {
        ...
        $delivery_boy_collection_query = $delivery_boy_collection_query->paginate($paginate);

        $delivery_boy_collections = $delivery_boy_collection_query;

        return view('backend.delivery_boys.delivery_boys_collection_list', compact('delivery_boy_collections', 'paginate'));
    }
    ...
    public function bulkExportDeliverBoys(Request $request)
    {
           return $this->handleBulkExport(
            $request,
            DeliveryBoysExport::class,
            'delivery_boys_export'
        );
    }
    public function bulkExportPaymentHistories(Request $request)
    {
          return $this->handleBulkExport(
            $request,
            DeliveryBoyPaymentHistoriesExport::class,
            'delivery_boy_payment_histories_export'
        );
    }
    public function bulkExportCollectionHistories(Request $request)
    {
          return $this->handleBulkExport(
            $request,
            DeliveryBoyCollectionHistoriesExport::class,
            'delivery_boy_collection_histories_export'
        );
    }
}
