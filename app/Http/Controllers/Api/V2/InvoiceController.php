...
class InvoiceController extends Controller
{
    ...
    public function get_options(){
        ...
        $language_code = request()->header('App-Language') != null ? request()->header('App-Language') : env('DEFAULT_LANGUAGE');

        if (Language::where('code', $language_code)->first()->rtl == 1 || $language_code == 'ar' || $language_code == 'he' || $language_code == 'fa' || $language_code == 'ur') {
            $direction = 'rtl';
            $text_align = 'right';
            $not_text_align = 'left';
        } else {
