...
use App\Http\Resources\V2\Seller\ProductShowDetailsResource;
...
class ProductController extends Controller
{
    ...
    {
        if($request->filled('category_id')){
            $brands = Category::where('id', $request->category_id)->first()->brands;
        } else {
        $brands = Brand::all();
        }
     ...
     public function show($id)
    {
        ...
        return new ProductShowDetailsResource($product);
    }
