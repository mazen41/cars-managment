                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                    ...
                    <div class="d-flex mt-3">
                        ...
                        <p class="ml-2 mb-0 fs-12 fw-500 text-justify text-gray-dark" style="color: #666; line-height: 18px;">
                            Note: Go to your server  and find the php <span class=" fw-900">extension/package</span> and disable <span class=" fw-900">pdo_mysql</span> then enable <span class=" fw-900">nd_mysqli</span> and <span class=" fw-900">nd_pdo_mysql</span> both for preventing value convert issue like an integer to string.
                        </p>
                    </div>
