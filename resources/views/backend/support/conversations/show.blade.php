    ...
    <div class="card shadow-sm">
        <div class="chat-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                @if($conversation->conversable_type === 'App\Models\Product')
                <a href="{{ route('product', $conversation->conversable->slug) }}" class="btn btn-soft-primary btn-sm"
                    target="_blank">
                    {{ translate('View Product') }}
                </a>
                @elseif($conversation->conversable_type === 'App\Models\ExternalOrder')
                <a href="{{ route('external_orders.show', encrypt($conversation->conversable->id)) }}"
            ...
            <div class="text-muted">
                {{-- Show additional details about the related model --}}
                @if($conversation->conversable_type === 'App\Models\Product')
                {{ translate('Product') }}: {{ $conversation->conversable->name }}
                @elseif($conversation->conversable_type === 'App\Models\ExternalOrder')
                {{ translate('Order') }} #{{ $conversation->conversable->id }}
                @endif
            </div>
            @endif
        </div>
        ...
        @if ($conversation->receiver != null && $conversation->receiver->user_type == 'admin' &&
        auth()->user()->can('reply_to_product_conversations'))
