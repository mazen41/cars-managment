    ...
    <div class="card-body border" style="background: #fcfcfc;">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                ...
                <br>
                <span class="fs-14 fw-500 ">{{ translate('From Bottom-left') }}</span>
            </div>
            <!-- From Bottom-right -->
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                ...
                <br>
                <span class="fs-14 fw-500 ">{{ translate('From Bottom-right') }}</span>
            </div>
            <!-- From Top-left -->
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                ...
                <br>
                <span class="fs-14 fw-500 ">{{ translate('From Top-left') }}</span>
            </div>
            <!-- From Top-right -->
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                ...
                <br>
                <span class="fs-14 fw-500 ">{{ translate('From Top-right') }}</span>
            </div>
        </div>
    </div>
</div>
