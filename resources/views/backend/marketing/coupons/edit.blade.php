        ...
        <div class="card">
            ...
            <form action="{{ route('coupon.update', $coupon->id) }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    @include('partials.coupons.customers_select_field', ['customers' => $coupon->users ?? [], 'is_welcome_coupon'=> $coupon->is_welcome_coupon])
                    <div id="coupon_form">
...
<script type="text/javascript">
    ...
    function coupon_form(){
        var coupon_type = $('#coupon_type').val();
         if(coupon_type != ''){
             $('#coupon_customers_fields').removeClass('d-none');
        } else{
             $('#coupon_customers_fields').addClass('d-none');
        }
        var id = $('#id').val();
