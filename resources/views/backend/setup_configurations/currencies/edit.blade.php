<form action="{{ route('your_currency.update') }}" method="POST" >
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" lang="en" step="0.001" min="0" placeholder="{{translate('Exchange Rate')}}" id="exchange_rate" name="exchange_rate" value="{{ $currency->exchange_rate }}" class="form-control" required>
            </div>
        </div>
    </div>
