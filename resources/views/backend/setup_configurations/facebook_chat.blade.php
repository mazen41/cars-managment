              ...
              <div class="card-header">
                ...
                <div class="card-body">
                    <ul class="list-group mar-no">
                        <li class="list-group-item ">1. {{ translate('Login into your facebook page') }}</li>
                        <li class="list-group-item ">2. {{ translate('Find the About option of your facebook page') }}.</li>
                        <li class="list-group-item ">3. {{ translate('At the very bottom, you can find the “Facebook Page ID”') }}.</li>
                        <li class="list-group-item ">4. {{ translate('Go to Settings of your page and find the option of "Advance Messaging"') }}.</li>
                        <li class="list-group-item ">5. {{ translate('Scroll down that page and you will get "white listed domain"') }}.</li>
                        <li class="list-group-item ">6. {{ translate('Set your website domain name') }}.</li>
                    </ul>
                </div>
            </div>
        </div>
