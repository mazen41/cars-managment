...
@hasrole('Tech Support')
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 h6 text-center">{{ translate('Test Code Verification') }}</h3>
                </div>
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'test_otp_code')" <?php if (get_setting('test_otp_code') == 1) {
                            echo 'checked';
                        } ?>>
                        <span class="slider round"></span>
                    </label>
                    <div class="alert"
                        style="color: #004085;background-color: #ff4141;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        {{ translate('Warning: This will make the generated otp code 123456') }}
                    </div>
                </div>
            </div>
        </div>
