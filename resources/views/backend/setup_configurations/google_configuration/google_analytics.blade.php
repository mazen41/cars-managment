            ...
            <div class="card bg-gray-light">
                ...
                <div class="card-body">
                    <ul class="list-group mar-no">
                        <li class="list-group-item ">1. {{ translate('Log in to Facebook and go to your Ads Manager account') }}.</li>
                        <li class="list-group-item ">2. {{ translate('Open the Navigation Bar and select Events Manager') }}.</li>
                        <li class="list-group-item ">3. {{ translate('Copy your Pixel ID from underneath your Site Name and paste the number into Facebook Pixel ID field') }}.</li>
                    </ul>
                </div>
            </div>
        </div>
