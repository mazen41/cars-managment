    ...
    <div class="col-md-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-group">
                    <li class="list-group-item ">{{ translate('Select sendmail for Mail Driver if you face any issue after configuring smtp as Mail Driver ') }}</li>
                    <li class="list-group-item ">{{ translate('Set Mail Host according to your server Mail Client Manual Settings') }}</li>
                    <li class="list-group-item ">{{ translate('Set Mail port as 587') }}</li>
                    <li class="list-group-item ">{{ translate('Set Mail Encryption as ssl if you face issue with tls') }}</li>
                </ul>
                <br>
                ...
                <ul class="list-group mar-no">
                    <li class="list-group-item ">{{ translate('Select sendmail for Mail Driver if you face any issue after configuring smtp as Mail Driver') }}</li>
                    <li class="list-group-item ">{{ translate('Set Mail Host according to your server Mail Client Manual Settings') }}</li>
                    <li class="list-group-item ">{{ translate('Set Mail port as 465') }}</li>
                    <li class="list-group-item ">{{ translate('Set Mail Encryption as ssl') }}</li>
                </ul>
            </div>
        </div>
    </div>
