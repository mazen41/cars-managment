    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                ...
                <div class="form-group row">
                    <input type="hidden" name="types[]" value="TWILIO_MESSAGING_SID">
                    <div class="col-lg-3">
                        <label class="col-from-label">{{ translate('TWILIO MESSAGING SID') }}</label>
                    </div>
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="TWILIO_MESSAGING_SID"
                            value="{{ env('TWILIO_MESSAGING_SID') }}" placeholder="{{ translate('TWILIO MESSAGING SID') }}">
                    </div>
                </div>
                <div class="form-group row d-none">
