...
@endphp
<!-- brands -->
<swiper-container style="height: 150px" class="dashboard-box-carousel half-outside-arrow" slides-per-view="3"
breakpoints='{
    "1500": {
      "slidesPerView": 6.5,
      "spaceBetween": 10
...
>
    ...
    @foreach ($top_brands_products as $key => $top_brands_product)
        <swiper-slide class="carousel-box top_brands_products @if ($key == $top_brands2[0]) active @endif" onclick="top_brands_products({{ $key }}, this)">
