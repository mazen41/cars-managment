<!-- categories -->
<swiper-container style="height: 150px" class="dashboard-box-carousel half-outside-arrow"
breakpoints='{
    "1500": {
      "slidesPerView": 6.5,
      "spaceBetween": 10
...
>
    ...
    @foreach ($top_categories_products as $key => $top_categories_product)
        <swiper-slide class="carousel-box topproducts top_category_products @if ($key == $top_categories2[0]) active @endif" onclick="top_category_products({{ $key }}, this)">
