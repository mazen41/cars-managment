<div class="row gutters-16">
    ...
    <div class="col-lg-6">
        <div class="row gutters-16">
            <!-- Total Products -->
            <div class="col-sm-6">
                <div class="dashboard-box bg-surface h-220px mb-2rem overflow-hidden">
    ...
    <div class="col-lg-6">
        <div class="row gutters-16">
            <!-- Total Sales -->
            <div class="col-sm-6">
                <div class="dashboard-box bg-surface mb-2rem overflow-hidden" style="height: 470px;">
                    <div class="d-flex flex-column justify-content-between h-100">
                        <!-- Total Sales -->
                        <div>
                    ...
                    <div class="d-flex flex-column justify-content-between h-100">
                        ...
                        <div class="">
                            <a href="{{ route('sellers.index') }}"
                                class="btn btn-md btn-soft-success btn-block rounded-2 mb-3">{{ translate('All Sellers')
                                }}</a>
                            <a href="{{ route('sellers.index') }}?approved_status=0"
                                class="btn btn-md btn-soft-danger btn-block rounded-2">{{ translate('Pending Sellers')
                                }}</a>
                        </div>
                    </div>
                    @else
                ...
                <div class="col-sm-6">
                    ...
                    <div
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <p class="fs-13 fw-600  mb-0">{{ translate('Order Placed') }}</p>
                        </div>
                        <h1 class="fs-24 fw-600 mb-0">
                            {{ $total_placed_order }}
                        </h1>
                    ...
                    <div
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <span class="fs-13 fw-600  mb-0">{{ translate('Confirmed Order') }}</span>
                        </div>
                        <h1 class="fs-24 fw-600 mb-0">
                    ...
                    <div
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <span class="fs-13 fw-600  mb-0">{{ translate('Processed Order') }}</span>
                        </div>
                        <h1 class="fs-24 fw-600 mb-0">
                    ...
                    <div
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <span class="fs-13 fw-600  mb-0">{{ translate('Order Shipped') }}</span>
                        </div>
                        <h1 class="fs-24 fw-600 mb-0">
                            {{ $total_shipped_order }}
                        </h1>
        ...
        <div class="row gutters-16">
            ...
            <div class="col-sm-6">
                <div class="dashboard-box px-0 mb-2rem overflow-hidden" style="height: 474px;">
                    ...
                    <!-- nav -->
                    <ul class="nav nav-tabs border-0 mb-3  mx-2" role="tablist"
                        aria-orientation="vertical">
                        <li class="nav-item">
                            <a class="nav-link active inhouse_top_categories" id="all-tab" href="#all" data-toggle="tab"
                        ...
                        <li class="nav-item">
                            <a class="nav-link inhouse_top_categories" id="month-tab" href="#month" data-toggle="tab"
                                data-target="MONTH" type="button" role="tab" aria-controls="month" aria-selected="true">
                                {{ translate('Month') }}
                            </a>
                        </li>
                    </ul>
            ...
            <div class="col-sm-6">
                <div class="dashboard-box px-0 mb-2rem overflow-hidden" style="height: 474px;">
                    ...
                    <!-- nav -->
                    <ul class="nav nav-tabs dashboard-tab-danger border-0 mb-3 mx-2" role="tablist"
                        aria-orientation="vertical">
                        <li class="nav-item">
    ...
    <div class="col-lg-6">
        <div class="dashboard-box bg-surface mb-2rem overflow-hidden p-2rem" style="height: 474px;">
            <!-- Header -->
            <div class="d-sm-flex align-items-center justify-content-between mb-3">
                ...
                <!-- nav -->
                <ul class="nav nav-tabs dashboard-tab-warning border-0  mx-2" role="tablist"
                    aria-orientation="vertical">
                    <li class="nav-item">
                        <a class="nav-link top_category_products_tab active" id="all-tab" href="#all" data-toggle="tab"
                            data-target="all" type="button" role="tab" aria-controls="all" aria-selected="true">
                            {{ translate('All') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link top_category_products_tab" id="today-tab" href="#today" data-toggle="tab"
                            data-target="DAY" type="button" role="tab" aria-controls="today" aria-selected="true">
                            {{ translate('Today') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link top_category_products_tab" id="week-tab" href="#week" data-toggle="tab"
                            data-target="WEEK" type="button" role="tab" aria-controls="week" aria-selected="true">
                            {{ translate('Week') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link top_category_products_tab" id="month-tab" href="#month" data-toggle="tab"
                            data-target="MONTH" type="button" role="tab" aria-controls="month" aria-selected="true">
                            {{ translate('Month') }}
                        </a>
                    </li>
        ...
        <div class="dashboard-box bg-surface mb-2rem overflow-hidden">
            <div class="row gutters-16">
                ...
                <div class="col-sm-6 d-flex flex-column justify-content-between">
                    ...
                    <div>
                        <h2 class="fs-16 fw-600  mb-2rem">{{ translate('In-house Store') }}</h2>
                        <h1 class="fs-30 fw-600  mb-1">
                            {{ single_price($total_inhouse_sale) }}
                        </h1>
                        <h4 class="fs-13 fw-600  text-secondary mb-0">{{ translate('Total Sales') }}</h4>
                    </div>
                    <!-- Order graph -->
                    <canvas id="graph-2" class="w-100 h-auto" height="200"></canvas>
                    <!-- All In-house Orders -->
                    <a href="{{ route('inhouse_orders.index') }}"
                        class="btn btn-md btn-soft-info btn-block rounded-2 mt-4 mb-4 mt-sm-0 mb-sm-0">{{ translate('All
                        In-house Orders') }}</a>
                </div>
        ...
        <div class="dashboard-box bg-surface mb-2rem overflow-hidden p-2rem" style="height: 474px;">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <ul class="nav nav-tabs dashboard-tab-warning border-0  mx-2" role="tablist"
                    aria-orientation="vertical">
                    <li class="nav-item">
                        <a class="nav-link top_sellers_products_tab active" id="all-tab" href="#all" data-toggle="tab"
                            data-target="all" type="button" role="tab" aria-controls="all" aria-selected="true">
                            {{ translate('All') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link top_sellers_products_tab" id="today-tab" href="#today" data-toggle="tab"
                            data-target="DAY" type="button" role="tab" aria-controls="today" aria-selected="true">
                            {{ translate('Today') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link top_sellers_products_tab" id="week-tab" href="#week" data-toggle="tab"
                            data-target="WEEK" type="button" role="tab" aria-controls="week" aria-selected="true">
                            {{ translate('Week') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link top_sellers_products_tab" id="month-tab" href="#month" data-toggle="tab"
                            data-target="MONTH" type="button" role="tab" aria-controls="month" aria-selected="true">
                            {{ translate('Month') }}
                        </a>
                    </li>
        ...
        <div class="dashboard-box bg-surface mb-2rem overflow-hidden p-2rem" style="height: 474px;">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <ul class="nav nav-tabs dashboard-tab-warning border-0  mx-2" role="tablist"
                    aria-orientation="vertical">
                    <li class="nav-item">
                        <a class="nav-link top_brands_products_tab active" id="all-tab" href="#all" data-toggle="tab"
                            data-target="all" type="button" role="tab" aria-controls="all" aria-selected="true">
                            {{ translate('All') }}
                        </a>
                    </li>
