    ...
    <div class="row gutters-16">
        ...
        <div class="col-lg-12">
            <div class="row gutters-16">
                ...
                <!-- Sale Report -->
                <div class="col-sm-3">
                    <div class="dashboard-box bg-surface h-220px mb-2rem overflow-hidden" style="min-height: 370px">
        ...
        <!-- Net Sales -->
        <div class="col-lg-6">
            <div class="dashboard-box bg-surface mb-2rem overflow-hidden p-2rem" style="">
                <!-- Header -->
