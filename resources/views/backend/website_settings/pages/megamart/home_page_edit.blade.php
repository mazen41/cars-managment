		...
		<div class="d-sm-flex">
			...
			<div class="page-side-nav c-scrollbar-light px-3 py-2">
				<ul class="nav nav-tabs flex-sm-column border-0" role="tablist" aria-orientation="vertical">
					...
					<li class="nav-item">
						<a class="nav-link" id="seller-tab" href="#seller"
							data-toggle="tab" data-target="#seller" type="button" role="tab" aria-controls="seller" aria-selected="false">
							{{ translate('Become Seller Section') }}
						</a>
					</li>
					@endif
				...
				<div class="tab-content">
										...
										<div class="w-100">
											...
											<div class="fs-11 d-flex mb-2rem">
												...
												<div class="ml-2 text-gray">
													<div class="mb-2">{{ translate('1352 x 560 pixels') }}</div>
					...
					<div class="tab-pane fade" id="banner_1" role="tabpanel" aria-labelledby="banner-1-tab">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="bg-surface p-3 p-sm-2rem">
								<div class="w-100">
									<label class="col-from-label fs-13 fw-500 mb-3">{{ translate('Banner & Links') }}</label>
									...
									<div class="row gutters-16">
                                        ...
                                        <div class="col-12">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3 d-flex">
													@php
														$coupons_cta_text_color =  get_setting('coupons_cta_text_color');
													@endphp
													<input type="hidden" name="types[]" value="coupons_cta_text_color">
													<div class="radio mar-btm mr-3 d-flex align-items-center">
														<input id="coupons_cta_text_light" class="magic-radio" type="radio" name="coupons_cta_text_color" value="light" @if(($coupons_cta_text_color == 'light') || ($coupons_cta_text_color == null)) checked @endif>
														<label for="coupons_cta_text_light" class="mb-0 ml-2">{{translate('Light')}}</label>
													</div>
													<div class="radio mar-btm mr-3 d-flex align-items-center">
														<input id="coupons_cta_text_dark" class="magic-radio" type="radio" name="coupons_cta_text_color" value="dark" @if($coupons_cta_text_color == 'dark') checked @endif>
														<label for="coupons_cta_text_dark" class="mb-0 ml-2">{{translate('Dark')}}</label>
													</div>
												</div>
											</div>
                                        </div>
									...
									<div class="row gutters-16">
										...
										<div class="col-lg-12">
											<div class="form-group">
												<label class="col-from-label fs-13 fw-500">{{ translate('Background color') }}</label>
												<div class="input-group mb-3">
													@php $cta_background_color = get_setting('cta_background_color') @endphp
													<input type="hidden" name="types[]" value="cta_background_color">
													<input type="text" class="form-control aiz-color-input" placeholder="#000000" name="cta_background_color" value="{{ $cta_background_color }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="aiz-color-picker border-0 size-40px" type="color" value="{{ $cta_background_color }}">
														</span>
													</div>
												</div>
											</div>
										...
										<div class="col-12">
											<div class="form-group">
												...
												<input type="hidden" name="types[][{{ $lang }}]" value="seller_desc">
												<input type="text" class="form-control" placeholder="{{ translate('Description') }}" name="seller_desc" value="{{ get_setting('seller_desc', null, $lang) }}">
											</div>
										</div>
                                        <div class="col-12">
                                            <!-- Banner Text Color -->
											<div class="form-group">
												...
												<div class="input-group mb-3 d-flex">
													@php
														$cta_text_color =  get_setting('cta_text_color');
													@endphp
													<input type="hidden" name="types[]" value="cta_text_color">
													<div class="radio mar-btm mr-3 d-flex align-items-center">
														<input id="cta_text_light" class="magic-radio" type="radio" name="cta_text_color" value="light" @if(($cta_text_color == 'light') || ($cta_text_color == null)) checked @endif>
														<label for="cta_text_light" class="mb-0 ml-2">{{translate('Light')}}</label>
													</div>
													<div class="radio mar-btm mr-3 d-flex align-items-center">
														<input id="cta_text_dark" class="magic-radio" type="radio" name="cta_text_color" value="dark" @if($cta_text_color == 'dark') checked @endif>
														<label for="cta_text_dark" class="mb-0 ml-2">{{translate('Dark')}}</label>
													</div>
												</div>
											</div>
                                        </div>
