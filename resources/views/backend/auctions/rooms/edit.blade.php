...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h1 class="h3">{{ translate('Edit Auction Room') }}</h1>
</div>
...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.auction-rooms.update', $room->id) }}" method="POST" id="auction-room-form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-9">
                            <select class="form-control aiz-selectpicker" name="currency_id" required>
                                @foreach($currencies as $currency)
                                    <option value="{{ $currency->id }}" @if(old('currency_id', $room->currency_id) == $currency->id) selected @endif>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <input type="number" class="form-control" name="commission_percentage" value="{{ old('commission_percentage', $room->commission_percentage) }}" min="0" max="100" step="0.01" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="form-control aiz-selectpicker" name="bid_increment_type" id="bid_increment_type" required>
                                <option value="percentage" @if(old('bid_increment_type', $room->bid_increment_type) == 'percentage') selected @endif>{{ translate('Percentage') }}</option>
                                <option value="flat" @if(old('bid_increment_type', $room->bid_increment_type) == 'flat') selected @endif>{{ translate('Flat Amount') }}</option>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="bid_increment_value" value="{{ old('bid_increment_value', $room->bid_increment_value) }}" min="0" step="0.01" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="base_timer_seconds" value="{{ old('base_timer_seconds', $room->base_timer_seconds) }}" min="10" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="extension_seconds" value="{{ old('extension_seconds', $room->extension_seconds) }}" min="5" required>
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="insurance_deposit_amount" value="{{ old('insurance_deposit_amount', $room->insurance_deposit_amount) }}" min="0" step="0.01" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="datetime-local" class="form-control" name="scheduled_start_at" value="{{ old('scheduled_start_at', $room->scheduled_start_at ? $room->scheduled_start_at->format('Y-m-d\TH:i') : '') }}">
                    ...
                    <div class="form-group mb-0 text-right">
                        ...
                        <button type="submit" class="btn btn-primary">{{ translate('Update Room') }}</button>
                    </div>
                </form>
            </div>
        </div>
