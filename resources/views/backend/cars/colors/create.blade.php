...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{translate('Add New Car Color')}}</h1>
        </div>
...
<form action="{{ route('admin.car-colors.store') }}" method="POST">
    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                value="{{ old('hex_code') }}" pattern="^#[A-Fa-f0-9]{3,6}">
                                <div class="input-group-append">
                                    <span class="input-group-text p-0">
                                        <input class="aiz-color-picker border-0 size-40px" type="color" value="{{ old('hex_code', '#FFFFFFF') }}">
                                    </span>
                                </div>
                            </div>
                            @error('hex_code')
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Color Preview -->
                    <div class="form-group row" id="color-preview-section" style="display: none;">
                        <label class="col-md-3 col-form-label">{{translate('Preview')}}</label>
                        <div class="col-md-9">
                            <div class="color-preview-large" style="width: 100%; height: 60px; border: 1px solid #ddd; border-radius: 4px; background-color: #ffffff;"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="form-group row">
        <div class="col-md-9 col-md-offset-3">
            <button type="submit" class="btn btn-primary">{{translate('Save Color')}}</button>
