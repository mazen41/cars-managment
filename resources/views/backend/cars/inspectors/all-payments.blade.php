...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Payment History') }}</h1>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table aiz-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                                <td>
                                    <div>{{ $payment->carInspector->shop_name ?? translate('N/A') }}</div>
                                    <div class="text-muted small">{{ $payment->carInspector->user->phone ?? translate('N/A') }}</div>
                                </td>
                                <td>
        ...
        @else
            <div class="text-center py-4">
                ...
                <p class="text-muted">{{ translate('No payment transactions found!') }}</p>
            </div>
        @endif
    </div>
</div>
