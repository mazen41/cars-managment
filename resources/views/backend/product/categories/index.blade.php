                ...
                @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge badge-inline badge-soft-success">{{ translate('Parent Category') }}</span>
                            @endif
                        </td>
                        ...
                        <td class="text-right">
                            @can('edit_product_category')
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('categories.edit', ['id'=>$category->id, 'lang'=>config('app.locale')] )}}" title="{{ translate('Edit') }}">
