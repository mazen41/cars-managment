                                        ...
                                        <div class="card p-4 @if($errors->has('category_ids') || $errors->has('category_id')) border border-danger @endif">
                                            ...
                                            <select class="select2 form-control aiz-selectpicker" id="category_id" name="category_id" onchange="getSubcategories()" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}" @if(old('category_id') == $category->id) selected @endif>{{ $category->getTranslation('name') }}</option>
                                                @endforeach
                                            </select>
                                            </div>
                                            {{-- SubCategoeis --}}
                                             <div class="form-group">
                                                ...
                                                <select class="select2 form-control aiz-selectpicker" id="subcategory_id" onchange="getBrands()" name="subcategory_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                                    <option value="0">{{ translate('Select') }}</option>
                                                </select>
                                            </div>
                                        </div>
