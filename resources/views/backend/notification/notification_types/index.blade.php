                    ...
                    <div class="table-responsive">
                        <table class="table aiz-table mb-0">
                            ...
                            <tbody>
                                ...
                                @if ($notificationType->type != 'custom' && !auth()->user()->hasRole('Tech Support'))
                                @continue
                                @else
                                    <tr>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            @can('edit_notification_types')
                                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                    href="{{ route('notification-type.edit', ['id' => $notificationType->id, 'lang' => config('app.locale')]) }}"
                    ...
                    <div class="card-body">
                        <form action="{{ route('notification-type.store') }}" method="POST">
                            ...
                            <select  class="form-control" name="user_type" >
                                ...
                                <option value="seller" >
                                    {{ translate('Seller') }}</option>
                                <option value="admin" >
                                    {{ translate('Admin') }}</option>
                            </select>
                            </div>
                            <div class="form-group mb-3">
                                <label for="type">{{ translate('Type') }} <span class="text-danger">*</span></label>
                                <input type="text" name="type" id="type" value="{{ old('Type') }}"
                                    class="form-control" placeholder="{{ translate('Type') }}" required>
                            </div>
                            @endhasrole
                            <div class="form-group mb-3">
