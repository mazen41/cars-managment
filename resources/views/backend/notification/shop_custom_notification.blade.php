    ...
    <div class="col-md-6 mx-auto">
        <div class="card">
            <div class="card-body" style="min-height:460px;">
                <form class="form-horizontal" action="{{ route('shop_custom_notification.send') }}" method="POST"
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 control-label fw-700" for="name">{{ translate('Shops') }}</label>
                        <div class="col-sm-9">
