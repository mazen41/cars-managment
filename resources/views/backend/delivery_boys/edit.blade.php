    ...
    <div class="card">
        ...
        <form action="{{ route('delivery-boys.update', $delivery_boy->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="phone">{{ translate('Phone') }} <span class="text-danger">*</span></label>
                    <div class="col-md-9">
                        <input type="text" dir="ltr" placeholder="{{ translate('Phone') }}" id="phone-code" name="phone" class="form-control" value="{{ $delivery_boy->phone }}" required>
