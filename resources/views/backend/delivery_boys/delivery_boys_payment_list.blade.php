...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h3 class="h3">{{translate('All Payment List')}}</h3>
        </div>
    </div>
</div>
...
<div class="card">
    <form class="" id="sort_delivery_boys" action="" method="GET">
        ...
        <div class="card-body">
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($delivery_boy_payment->user != null)
            ...
            <x-table_pagination :data="$delivery_boy_payments" :paginate="$paginate" />
        </div>
    </form>
</div>
</div>
...
<script>
    (function($) {
        ...
        function bulk_export (type){
            var url = '{{route('delivery-boys-bulk-export-payment-histories')}}';
