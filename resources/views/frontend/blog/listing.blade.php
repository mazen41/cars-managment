            ...
            <div class="row gutters-16">
                ...
                <div class="col-xl-9 order-xl-1">
                    ...
                    <div class="row gutters-16 mb-4">
                        <div class="col-5 col-xl-6">
                            <h1 class="fw-700 fs-20 fs-md-24  mb-0">{{ translate('Blogs')}}</h1>
                        </div>
                        <div class="col-5 col-xl-6">
                            <ul class="breadcrumb bg-transparent p-0 justify-content-end">
                                ...
                                <li class=" fw-600 breadcrumb-item">
                                    "{{ translate('Blog') }}"
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-xl-3">
                    ...
                    <form class="mb-4" id="search-form" action="" method="GET">
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left" style="overflow-y: auto;">
                                ...
                                <!-- Categories -->
                                <div class="bg-surface border mb-3 mx-3 mx-xl-0">
                                    ...
                                    <div class="p-3 aiz-checkbox-list">
                                        ...
                                        <label class="aiz-checkbox mb-3">
                                            ...
                                            <span class="fs-14 fw-400  has-transition hov-text-primary">{{ $category->category_name }}</span>
                                        </label>
                                        @endforeach
                                    </div>
                                </div>
                    ...
                    <div class="p-3 border">
                        <h3 class="fs-16 fw-700  mb-3">{{ translate('Recent Posts') }}</h3>
                        <div class="row">
