<div class="top-navbar bg-surface z-1035 h-35px h-sm-auto d-lg-none">
    <div class="container">
        <div class="row">
                ...
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                        <a class="d-lg-block d-none py-20px mr-3 ml-0" href="{{ route('home') }}">
                            @php
                                $header_logo = get_setting('header_logo') ? uploaded_asset(get_setting('header_logo')) : static_asset('assets/img/logo.png');
                            @endphp
                           <a class="d-lg-none py-2" href="{{ route('home') }}">
                                <img src="{{ $header_logo }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-30px h-md-50px" height="60">
                        </a>
