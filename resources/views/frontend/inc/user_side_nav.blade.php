<div class="aiz-user-sidenav-wrap position-relative z-1 rounded-0">
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="p-4 text-center mb-4 border-bottom position-relative">
            ...
            <!-- Name -->
            <h4 class="h5 fs-14 mb-1 fw-700 ">{{ $user->name }}</h4>
            <!-- Phone -->
            @if ($user->phone != null)
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('dashboard') }}" class="aiz-side-nav-link {{ areActiveRoutes(['dashboard']) }}">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('My Profile') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0)" onclick="account_delete_confirm_modal('{{ route('account_delete') }}')" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text text-danger ml-3">{{ translate('Delete My Account') }}</span>
                    </a>
                </li>
            ...
            <!-- logout -->
            <a href="{{ route('logout') }}" class="btn btn-outline-dark btn-block fs-14 fw-700 mb-5 mb-md-0" style="border-radius: 25px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15.999" viewBox="0 0 16 15.999">
                    <g id="Group_25503" data-name="Group 25503" transform="translate(-24.002 -377)">
                        <g id="Group_25265" data-name="Group 25265" transform="translate(-216.534 -160)">
                            <path id="Subtraction_192" data-name="Subtraction 192" d="M12052.535,2920a8,8,0,0,1-4.569-14.567l.721.72a7,7,0,1,0,7.7,0l.721-.72a8,8,0,0,1-4.567,14.567Z" transform="translate(-11803.999 -2367)" fill="#d43533"></path>
                        </g>
                        <rect id="Rectangle_19022" data-name="Rectangle 19022" width="1" height="8" rx="0.5" transform="translate(31.5 377)" fill="#d43533"></rect>
                    </g>
                </svg>
                {{ translate('Sign Out') }}
            </a>
