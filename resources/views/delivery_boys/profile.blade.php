...
@section('panel_content')
    <div class="aiz-titlebar mb-4">
      <div class="row align-items-center">
        <div class="col-md-6">
            <h3 class="fs-20 fw-700 ">{{ translate('Manage Profile') }}</h3>
        </div>
      </div>
    </div>
    ...
    <div class="card shadow-none rounded-0 border">
        <div class="card-header border-bottom-0">
            <h5 class="mb-0 fs-16 fw-700 ">{{ translate('Basic Info')}}</h5>
        </div>
        <div class="card-body">
    ...
    <div class="card shadow-none rounded-0 border">
        <div class="card-header border-bottom-0">
            <h5 class="mb-0 fs-16 fw-700 ">{{ translate('Change your email')}}</h5>
        </div>
        <div class="card-body">
