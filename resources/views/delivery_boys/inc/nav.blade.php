                ...
                <div class="ml-auto mr-0">
                    @auth
                        <span class="d-none d-xl-flex align-items-center nav-user-info py-20px" id="nav-user-info">
                            ...
                            <!-- Name -->
                            <h4 class="h5 fs-14 fw-700  ml-2 mb-0">{{ Auth::user()->name }}</h4>
                        </span>
                    @else
                        <!--Login & Registration -->
        ...
        <div class="hover-user-top-menu position-absolute top-100 left-0 right-0 z-3">
            <div class="container">
                <div class="position-static float-right">
                    <div class="aiz-user-top-menu bg-surface rounded-0 border-top shadow-sm" style="width:220px;">
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="{{ route('dashboard') }}" class="text-truncate  px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="{{ route('logout') }}" class="text-truncate  px-4 fs-14 d-flex align-items-center hov-column-gap-1">
