...
@section('panel_content')
    ...
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h3 class="fs-20 fw-700 ">{{ translate('Order id')}}: {{ $order->code }}</h3>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-none rounded-0 border mt-4">
        <div class="card-header border-bottom-0">
            <b class="fs-16 fw-700 ">{{ translate('Order Summary') }}</b>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6">
    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card mt-4 shadow-none rounded-0 border">
                <div class="card-header border-bottom-0">
                    <b class="fs-16 fw-700 ">{{ translate('Order Details') }}</b>
                </div>
        ...
        <div class="col-lg-3">
            <div class="card mt-4 shadow-none rounded-0 border">
                <div class="card-header border-bottom-0">
                    <b class="fs-16 fw-700 ">{{ translate('Order Ammount') }}</b>
                </div>
                <div class="card-body pb-0">
                    <table class="table table-borderless">
                        <tbody>
