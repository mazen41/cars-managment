                    ...
                    <div class="d-flex align-items-center right-content">
                        <div class="py-3 py-lg-4 px-3 px-xl-5 flex-grow-1">
                            ...
                            <div class="text-center text-lg-left">
                                ...
                                <h5 class="fs-14 fw-400 ">{{ translate('Login To Your Seller Account')}}</h5>
                            </div>
                            <!-- Login form -->
                                        ...
                                        @csrf
                                         ...
                                         @if (addon_is_activated('otp_system'))
                                             ...
                                             <div class="form-group text-right">
                                                 <button class="btn toggle-email-phone btn-link p-0 text-primary fs-12 fw-400" type="button" onclick="toggleEmailPhone(this)"><i>*{{ translate('Use Email Instead') }}</i></button>
                                             </div>
                                         @else
