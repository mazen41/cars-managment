    ...
    <div class="row gutters-10 justify-content-center">
        ...
        <div class="col-md-4 mx-auto mb-3" >
            <a href="{{ route('seller.products.create')}}">
              <div class="p-3 rounded mb-3 c-pointer text-center bg-surface shadow-sm hov-shadow-lg has-transition">
        ...
        @endphp
        <div class="col-md-4">
            <a href="{{ route('seller.seller_packages_list') }}" class="text-center bg-surface shadow-sm hov-shadow-lg text-center d-block p-3 rounded">
