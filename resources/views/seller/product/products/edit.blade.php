            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        {{-- @php
                            $currencies = get_all_active_currency();
                            $default_currency = get_system_currency()->code;
                        @endphp
                        <div class="col-md-4">
                            <select class="form-control aiz-selectpicker" name="price_currency">
                                @foreach ($currencies as $currency)
                                    <option value="{{$currency->code}}" @if ($currency->code == $default_currency)
                                        selected
