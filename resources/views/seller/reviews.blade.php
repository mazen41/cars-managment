            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    @foreach ($reviews as $key => $review)
                        @if($review != null && $review->reviewable != null && $review->user != null)
                            <tr>
                                <td>
                                    {{ $key+1 }}
                                </td>
                                <td>
                                    <a href="{{ route('product', $review->reviewable->slug) }}" target="_blank">{{  $review->reviewable->getTranslation('name') }}</a>
                                </td>
