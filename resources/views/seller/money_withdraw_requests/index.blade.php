...
@section('panel_content')
    ...
    <div class="row gutters-10">
        ...
        <div class="col-md-4 mb-3 mr-auto" >
          <div class="p-3 rounded mb-3 c-pointer text-center bg-surface shadow-sm hov-shadow-lg has-transition" onclick="show_request_modal()">
...
@section('script')
    <script type="text/javascript">
       function show_request_modal(){
            ...
            AIZ.plugins.notify('danger', "{{translate('You need to set your payemnt details first!')}}");
        }
    }
