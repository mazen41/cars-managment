        ...
        <div class="card-body">
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        <th>#</th>
                        <th data-breakpoints="lg">{{ translate('Reference Code') }}</th>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($history->commissionable_type == 'App\Models\Order')
                                {{ translate('Order') }}
                            @elseif($history->commissionable_type == 'App\Models\CarReservation')
                                {{ translate('Car Reservation') }}
                            @elseif($history->commissionable_type == 'App\Models\AuctionInvoice')
                                {{ translate('Auction Invoice') }}
                            @endif
                        <td>{{ $history->admin_commission }}</td>
                        <td>{{ $history->ownable_earning }}</td>
