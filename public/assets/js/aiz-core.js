...
(function ($) {
    ...
    AIZ.plugins = {
        ...
        countDownBox: function () {
            if ($(".aiz-count-down-box").length > 0) {
                $(".aiz-count-down-box").each(function () {
                    ...
                    var date = $this.data("date");
                    // console.log(date)
                    let isAr = $('html').prop('dir') == 'rtl' ? true : false;
                    var daysStr = isAr? 'أيام' : 'Days';
                    var hrsStr = isAr? 'ساعات' : 'Hours';
                    var minsStr = isAr? 'دقائق' : 'Minutes';
                    var secsStr = isAr? 'ثواني' : 'Seconds';
                        ...
                        .on("update.countdown", function (event) {
                            var $this = $(this).html(
                                event.strftime(
                                    ...
                                    '<div class="countdown-item"><span class="countdown-digit">%-D</span><span class="countdown-name"> '+daysStr+' </span></div><span class="countdown-separator">|</span>'+
                                    '<div class="countdown-item"><span class="countdown-digit">%H</span><span class="countdown-name"> '+hrsStr+' </span></div><span class="countdown-separator">|</span>' +
                                    '<div class="countdown-item"><span class="countdown-digit">%M</span><span class="countdown-name"> '+minsStr+' </span></div><span class="countdown-separator">|</span>' +
                                    '<div class="countdown-item"><span class="countdown-digit">%S</span><span class="countdown-name"> '+secsStr+' </span></div>'
        ...
        countDownCircle: function () {
            let html =
                '<div id="time">'+
                '<svg width="0" height="0"><defs><linearGradient x1="0%" x2="100%" y1="100%" y2="0%" id="flash-gradient"><stop offset="5%" stop-color="var(--gradient-start)"></stop><stop offset="95%" stop-color=var(--gradient-stop)></stop></linearGradient></defs></svg>'+
                '<div class="circle"><svg><circle cx="30" cy="30" r="30"></circle><circle cx="30" cy="30" r="30" id="dd"></circle></svg><div id="days">00 <br><span>Days</span></div></div>' +
                ...
                $(".aiz-count-down-circle").each(function () {
                    ...
                    let x = setInterval(function () {
                        ...
                        if (distance > 0) {
                            ...
                            days.html(d + "<br><span>"+daysStr+"</span>");
                            hours.html(h + "<br><span>"+hrsStr+"</span>");
                            minutes.html(m + "<br><span>"+minsStr+"</span>");
                            seconds.html(s + "<br><span>"+secsStr+"</span>");
    ...
    AIZ.extra = {
        ...
        toggleTheme: function () {
            $('#theme-change').click(function() {
                ...
                const logoEl = document.querySelector('.sidenav-logo');
                if(currentTheme === 'light'){

                logoEl.src = logoEl.getAttribute('data-white-logo');

                } else {
                    logoEl.src = logoEl.getAttribute('data-dark-logo');
                }
