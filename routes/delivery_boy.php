...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function(){
    ...
    Route::controller(DeliveryBoyController::class)->group(function () {
        ...
        Route::get('/delivery-boy/bulk-export', 'bulkExportDeliverBoys')->name('delivery-boys-bulk-export');
        Route::get('/delivery-boy/bulk-export-payment-histories', 'bulkExportPaymentHistories')->name('delivery-boys-bulk-export-payment-histories');
        Route::get('/delivery-boy/bulk-export-collection-histories', 'bulkExportCollectionHistories')->name('delivery-boys-bulk-export-collection-histories');
