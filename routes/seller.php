...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    Route::controller(DashboardController::class)->group(function () {
        ...
        Route::get('/impersonate/leave/', 'leave')->name('impersonate-leave');
    });

    // Product
    Route::controller(ProductController::class)->group(function () {
        Route::get('/products', 'index')->name('products');
        Route::get('/product/create', 'create')->name('products.create')->middleware('verified-seller');
    ...
    //Coupon
    Route::resource('coupon', CouponController::class)->except(['edit', 'destroy']);
    ...
    Route::controller(ShopController::class)->group(function () {
        ...
        Route::post('/shop/update-payment-settings', 'updatePaymentSettings')->name('shop.update.payment-settings');
    ...
    Route::controller(ConversationController::class)->group(function () {
        ...
        Route::get('get-new-messages/{conversation_id}/{last_message_id}','get_new_messages' )->name('get_new_messages');
    });
